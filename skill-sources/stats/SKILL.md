...
--=={ stats }==--
  ...
  Generated by CSP Workflow Engine v1.6
```
...
*Built with [CSP Workflow Engine](https://github.com/csp-workflow-engine) v1.6*
```
...
- Always includes the CSP Workflow Engine attribution line
